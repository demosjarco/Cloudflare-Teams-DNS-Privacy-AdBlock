...
export class Settings {
	...
	setupDiagnostics() {
		this.localStorageDiagnostics();
		this.localEncryptionDiagnostics();
		this.localAuthenticationDiagnostics();
	}
	...
	localStorageDiagnostics() {
		...
		$(() => {
			...
			$("div#settingsModal span#localStorageAvailable").addClass(`bg-${localStorageAvailable ? 'success' : 'danger'}`);
			if (!localStorageAvailable) {
				$('div.modal#settingsModal div.modal-footer').append(`<div class="alert alert-danger mt-3" role="alert">
	...
	localAuthenticationDiagnostics() {
